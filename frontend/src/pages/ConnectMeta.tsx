...
const S = {
  ...
  btn: (disabled: boolean, color = "#06d6a0"): React.CSSProperties => ({
    ...
    background: disabled
      ...
      : `linear-gradient(135deg,${color},${color === "#06d6a0" ? "#4f6ef7" : color})`,
...
const ConnectMeta: React.FC = () => {
  ...
  const launchSignup = () => {
    if (!window.FB) {
      setStatus("Facebook SDK not loaded yet. Please wait and try again.");
      return;
    }
    setLoading(true);
    setStatus(null);
    ...
    window.FB.login(
      (response: any) => {
        ...
        api
          .post("/whatsapp/onboard", { code: response.authResponse.code })
          .then(({ data }) => {
            setStatus(
    ...
    <div style={S.page}>
      <div style={{ marginBottom: 22 }}>
        ...
        <div style={{ fontSize: 13.5, color: "#8b90b8", lineHeight: 1.6 }}>
          Link your WhatsApp Business Account via Meta Embedded Signup. Takes
          under 60 seconds.
        </div>
      </div>
      ...
      <div style={S.card}>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: "#4a4f72" }}>
              Meta Embedded Signup · One-click setup
            </div>
          </div>
          <div
            style={{
      ...
      <div style={S.card}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          {[
            {
              n: 1,
              title: "Meta popup opens",
              sub: "Log in with your Facebook account",
            },
            {
              n: 2,
              title: "Select your WABA",
              sub: "Choose your WhatsApp Business Account",
            },
            {
              n: 3,
              title: "Token saved securely",
              sub: "Encrypted and stored automatically",
            },
            {
              n: 4,
              title: "AI agent activated",
              sub: "OmniAgent can now send & receive WhatsApp messages",
            },
          ].map(({ n, title, sub }) => (
            <div
              key={n}
            ...
            >
              <div
                style={{
                  ...
                  flexShrink: 0,
                  background:
                    "linear-gradient(135deg,rgba(79,110,247,0.2),rgba(124,58,237,0.2))",
